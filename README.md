# Ulearn
В данный момент я заканчиваю 1 курс. В этом репозитории размещены МОИ решения для курсов Ulearn.
## Рекомендации
...
Можете попробовать объяснить код какой-нибудь CHAT-GPT или Deepseek, они неплохие учителя.
## Особенности
...
будет служить НЕ источником списывания, а знаний. (ну и может HR его посмотрит).
## Другие источники
...
Можете почитать Метанит(https://metanit.com/sharp/), слишком полезный ресурс, чтобы его игнорировать.\
...
по улучшению кода.\ Спасибо команде Контуру за этот бесплатный курс, спасибо моему преподавателю, удачи в освоении будущим учащимся!
